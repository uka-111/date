  ...
  return (
    <main className="entry-page session-page">
      <section className="entry-card session-card card">
        ...
        <button className="icon-button settings-trigger session-settings-trigger" type="button" aria-label="设置" onClick={() => setSettingsOpen(true)}><span aria-hidden="true">⚙</span></button>
